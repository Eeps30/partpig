...
--
-- Host: localhost
-- Generation Time: Apr 05, 2018 at 10:30 PM
...
(23, NULL, 'https://s3.us-east-2.amazonaws.com/teampartpig/images/part7/part8ab.jpg', NULL, 8),
...
(27, NULL, 'https://s3.us-east-2.amazonaws.com/teampartpig/images/part8/part9b.jpg', NULL, 9),
...
INSERT INTO `part` (`id`, `part_name`, `description`, `part_condition`, `status`, `brand`, `make`, `model`, `year`, `seller_id`, `listing_ID`, `buyer_id`, `part_number`, `sku`, `price_usd`, `msrp_usd`, `original_purchase_date`, `listed_date`, `sold_date`, `part_data`) VALUES
(1, 'Roctection Hitch Mounted Mud Flaps', 'Access Rockstar Roctection Universal (Fits Most P/Us & SUVs) 80in. Wide Hitch Mounted Mud Flaps', '2 -- Mediumly used', '', 'Agricover', 'Toyota', 'Camry', 2018, 1, NULL, 3, 'accC100001', 'C100001', '210.500', '279.000', NULL, '2018-03-25 01:51:31', '0000-00-00 00:00:00', NULL),
(2, 'Catback Exhaust and Mufflers', '2015 SUBARU IMPREZA WRX STI SEDAN OEM CATBACK EXHAUST w/ MUFFLERS. Taken off at 27k miles. $160 obo. SERIOUS BUYERS ONLY\r\n    ', '', 'For sale', 'OEM', 'Subaru', 'Impreza WRX STI', 2015, 2, NULL, NULL, 'V0384111928', NULL, '160.000', NULL, '2016-05-13', '2018-04-03 01:28:47', '0000-00-00 00:00:00', NULL),
(3, 'Lowering springs', 'Complete set, rears are complete with shock/strut still assembled, Just unbolt and swap. Fronts are just the springs, go onto your stock struts.', '', 'Shipped', 'Tein', 'Subaru', 'Impreza WRX STI', 2008, 3, NULL, NULL, 'V0384641728', NULL, '110.000', NULL, '2009-03-19', '2018-04-03 01:36:47', '0000-00-00 00:00:00', NULL),
(4, '17x7 ENKEI OZ F1 CUP Wheels', 'Legit OZ F1 CUP wheels, repainted. Made in Italy. 17x7 - 4x100/4x114. No curb rash, dings or dents.\r\n', '', 'Sold', 'ENKEI', 'Honda', 'Civic', 2012, 4, NULL, NULL, 'V0389644871', NULL, '330.000', NULL, '2013-05-07', '2018-04-03 01:43:42', '0000-00-00 00:00:00', NULL),
(5, 'Volkswagen Jetta/Golf O.E.M. Instrument-Cluster', 'This is an original VW OEM. part. Fits 1999-2001 Jettas & Golfs. 160m.p.h. speedometer. O.E.M. part# is : 1J0 920 905JX. These are selling on eBay for between $550.- to $650. Price negotiable(cash or trade)\r\n', '', 'In storage', 'OEM', 'Volkswagen', 'Jetta', 1999, 5, NULL, NULL, '1J0 920 905JX', NULL, '85.000', NULL, '1999-02-17', '2018-04-03 01:43:42', '0000-00-00 00:00:00', NULL),
(6, 'Catalytic Converter Front Pipe', 'OEM Mazda Part - 3.0 L Mazda 6 front pipe converter. Year 2003 to 2005. New.', '', 'For sale', 'OEM', 'Mazda', 'Mazda 6', 2003, 2, NULL, NULL, 'V0389244137', NULL, '189.000', NULL, '2014-02-16', '2018-04-03 01:52:06', NULL, NULL),
(7, '2017 Jeep Wrangler OEM Font Rear Bumper', 'I\'m selling OEM front and rear bumper for $80. Front bumper has a dent at right corner. Serious buyer only.', '', 'Sold', 'OEM', 'Jeep', 'Wrangler', 2017, 4, NULL, NULL, 'V0365294691', NULL, '80.000', NULL, '2016-11-21', '2018-04-03 01:52:06', NULL, NULL),
(8, 'BMW 335i injectors 6', 'BMW 335i E92 set of 6 working injectors 3 of them are index 11 and the other 3 are index 10. No issues with them. Asking $300, call or text.', '', 'For sale', 'OEM', 'BMW', '335i', 2015, 5, NULL, NULL, 'V0311542693', NULL, '300.000', NULL, '2015-03-21', '2018-04-03 02:00:41', NULL, NULL),
(9, '2002 Mercedes Benz ml320 driver side headlight', '2002 Mercedes Benz ml320 driver side headlight will fit from 2002 to 2005 also will fit ml430, asking $149.99. Call or text.', '', 'In storage', 'OEM', 'Mercedes', 'ml320', 2002, 4, NULL, NULL, 'MB2503114', NULL, '149.990', NULL, '2002-09-18', '2018-04-03 02:00:41', NULL, NULL);
